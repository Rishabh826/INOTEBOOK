...
const Signup = () => {
  ...
  const [accountCreated, setAccountCreated] = useState(false); // State to control Accountcreated component rendering
  ...
  const handleSubmit = async (e) => {
    ...
    if (json.success) {
      ...
      // Navigate to the home page after the promise resolves
      mypromise.then(() => {
        navigate("/");
      });
    } else {
